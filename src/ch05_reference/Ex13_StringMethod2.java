...
public class Ex13_StringMethod2 {
	...
	public static void main(String[] args) {
		...
		// 정규표현식 사용 가능
		String regExp = str2.replaceAll("[?.]","*");	// ? 또는 . 을 *러 변경해라
		...
		System.out.println(now);					// 2024-01-17T14:26:31.711629300
